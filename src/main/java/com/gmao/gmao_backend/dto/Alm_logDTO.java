...
public class Alm_logDTO {
    ...
    public Alm_logDTO(Long id, String articulo, String categoria, String cod_almacen, String nom_almacen, String cantidad, String precio, String cod_proveedor, String nom_proveedor, String fecha, String causa) {
        this.id = id;
