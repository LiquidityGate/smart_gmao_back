...
public class ConfiguracionTipoAsignacionDTO {
    ...
    // Constructor vacío
    public ConfiguracionTipoAsignacionDTO() {
    }

    public ConfiguracionTipoAsignacionDTO(Long id, String nombre, Boolean estado, Boolean estadoEliminado,
