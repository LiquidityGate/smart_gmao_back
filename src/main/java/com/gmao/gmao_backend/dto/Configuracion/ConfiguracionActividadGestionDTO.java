...
public class ConfiguracionActividadGestionDTO {
    ...
    // Constructor vacío
    public ConfiguracionActividadGestionDTO() {
    }

    public ConfiguracionActividadGestionDTO(Long id, String nombre, Boolean estado, Boolean estadoEliminado,
            Timestamp creadoEn, Long creadoPorId, String creadoPorNombre, Timestamp actualizadoEn,
            Long actualizadoPorId, String actualizadoPorNombre) {
        this.id = id;
        this.nombre = nombre;
        this.estado = estado;
