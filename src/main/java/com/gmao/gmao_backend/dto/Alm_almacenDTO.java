...
public class Alm_almacenDTO {
    ...
    public Alm_almacenDTO() {}

    public Alm_almacenDTO(Long id, String nombre, String cod_alm_padre, String nom_alm_padre, String ubicacion, String estado) {
        this.id = id;
        this.nombre = nombre;
