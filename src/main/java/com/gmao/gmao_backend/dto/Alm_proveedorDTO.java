...
public class Alm_proveedorDTO {
    ...
    public Alm_proveedorDTO(){}

    // Constructor
    public Alm_proveedorDTO(long id, String ruc, String razon_social, String nom_comercial, String direccion, 
