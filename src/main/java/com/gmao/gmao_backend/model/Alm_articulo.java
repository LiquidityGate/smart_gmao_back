...
public class Alm_articulo {
    ...
    // Constructor
    public Alm_articulo(Long id, String nombre, String proveedor, String fabricante, String marca, String modelo, String stock_minimo, String stock_maximo, String estado) {
        this.id = id;
        this.nombre = nombre;
