...
@Entity
@Table(name = "g_alm_ent_sals")
public class Alm_ent_sal {
    ...
    // Constructor
    public Alm_ent_sal(Long id, String articulo, String cod_alm_padre, String nom_alm_padre, String proveedor, String cant_entrada, String precio_total, String estado) {
        this.id = id;
