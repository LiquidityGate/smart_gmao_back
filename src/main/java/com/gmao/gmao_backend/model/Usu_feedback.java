...
@Entity
@Table(name = "g_feedback_ux")
public class Usu_feedback {
    ...
    @Column(name = "archivo_img")
    private String archivo_img;
    
    @Column(name = "satisfaccion_ux")
    private Long satisfaccion_ux;
    
    @Column(name = "navegacion_ux")
    private Long navegacion_ux;
    
    @Column(name = "visual_ux")
    private Long visual_ux;
    
    @Column(name = "informacion_ux")
    ...
    @Column(name = "fecha_rpt")
    private String fecha_rpt;
    
    @Column(name = "id_usu_rpt")
    private Long id_usu_rpt;
    
    @Column(name = "estado_aten")
    ...
    public Usu_feedback(Long id, Long id_usuario, Long id_menu, String archivo_img, Long satisfaccion_ux, 
